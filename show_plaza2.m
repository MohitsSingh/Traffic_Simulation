...
PLAZA(PLAZA>=888)=0.3;
% global cheliuliang;
% cheliuliang=sum(plaza(50,2:4)==1)+cheliuliang;
global cheliuliang;
...
excuse(4:57,1:5,1:3)=rot90(rot90(PLAZA(101:154,1:5,1:3)));
excuse(56:60,4:57,1:3)=rot90(rot90(rot90(PLAZA(46:99,1:5,1:3))));
excuse(4:57,56:60,1:3)=PLAZA(1:54,1:5,1:3);
excuse(1:5,4:57,1:3)=rot90(PLAZA(1:54,1:5,1:3));
